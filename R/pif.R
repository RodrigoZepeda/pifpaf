...
#'
#' @description Function for estimating the Potential Impact Fraction `pif`
#'   from a cross-sectional sample of the exposure `X` with known Relative
#'   Risk function `rr` with parameter `theta`, where the Potential
...
#'
#' @param X Exposure and covariates.Can be any of the following:
#'  + (`data.frame`) of individual level data,
#'  + (`vector`) of aggregated means of exposure and covariates.
#'
#' @param thetahat (`vector`) Parameter of the relative risk function.
#'
#' @param rr (`function`) The Relative Risk function which uses parameter
#'   `theta`. The order (and naming) of the parameters should be `rr(X, theta)`.
#'
#' **Optional**
#'
#' @param cft   (`function`) The Relative Risk function which uses parameter
#'   `theta`. The order (and naming) of the parameters should be `rr(X, theta)`.
...
#'
#' @param derivative_method (`string`) Any of the following:
#'
#'
#'
